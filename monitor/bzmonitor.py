...
class bzMonitor():
	def __init__(self, ):
		...
		self.uid = ['11442277','386234695','483311105','4401694','388657573','319076','7887262','125526','430726','25910292','25876945','149558293','946974']
	#获取各用户的json连接
	def getbzurl(self):
		try:
			self.bzurl = []
			for i in self.uid:
				url = 'https://api.bilibili.com/x/space/arc/search?mid=%s'%(i)
